...
class Board {
    ...
    //Variables to hold scores, user start value, # turns, skin, AI value and rules
    int score=0;
    int highScore;
    int startValue_;
    int turns=0;
    ...
    //Function to set the rules bool
    void setRulesBool(bool rules){
        rulesbool=rules;
    }
    //Function to set the rules bool
    ...
    //Function to set the draw input
    void setDrawInput(int drawInput){
        drawInput_ = drawInput;
    }
    ...
    //Getter for the rules option
    bool getRulesBool() {
        bool rulesbool_ = rulesbool;
        return rulesbool_;
    }
